        ...
        <?php
            ...
            echo "<div class=\"w3-top w3-theme\">";
                ...
                echo "<div class=\"w3-display-topleft\">";
                    echo "<td><input type=\"submit\" class=\"w3-button w3-blue w3-round-large w3-xxlarge\" onclick=\"window.location.href='http://aalproject.000webhostapp.com/aal/api/reminders/read.php'\" name=\"action\" value=\"⇦\" /></td></p>";
                echo "</div>";
            ...
            echo "<div class=\"w3-display-middle w3-container\">";
		        ...
		        echo "<form id=\"entry\" class=\"sign-entry-htm\" action=\"http://aalproject.000webhostapp.com/aal/api/reminders/create.php\" method=\"POST\">";
    		        ...
    		        echo "<input type=\"submit\" class=\"w3-block w3-button w3-blue w3-round-large w3-large\" value=\"Αποθήκευση\">";
