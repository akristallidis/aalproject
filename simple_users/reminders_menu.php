...
<html lang="en" >
    ...
    <span id='ct' ></span>
        ...
        <?php
            ...
            echo "<td><input type=\"button\" class=\"w3-block w3-button w3-blue w3-round-large w3-large\" value=\"Οι υπενθυμίσεις μου\" onclick=\"window.location.href='http://aalproject.000webhostapp.com/aal/api/reminders/read_for_user.php'\" /></td></p>";
            
            echo "<td><input type=\"button\" class=\"w3-block w3-button w3-blue w3-round-large w3-large\" value=\"Δραστηριότητες Υπηρεσιών\" onclick=\"window.location.href='http://aalproject.000webhostapp.com/aal/api/users/read_social_services_users.php'\" /></td></p>";
