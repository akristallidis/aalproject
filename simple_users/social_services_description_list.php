...
<html lang="en" >
    ...
    <span id='ct' ></span>
        ...
        <?php
            ...
            $rows = $_SESSION['all_subscriptions_users_num']; //Dynamic number for Rows
            ...
            echo "<div class=\"w3-top w3-theme\">";
                ...
                echo "<div class=\"w3-display-topleft\">";
                    echo "<td><input type=\"submit\" class=\"w3-button w3-blue w3-round-large w3-xxlarge\" onclick=\"window.location.href='http://aalproject.000webhostapp.com/aal/simple_users/social_services_menu.php'\" name=\"action\" value=\"⇦\" /></td></p>";
                echo "</div>";
            ...
            echo "<div class=\"w3-display-middle w3-container\">";
                ...
                echo "<form action=\"http://aalproject.000webhostapp.com/aal/simple_users/middle_check_user_subscription_description.php \" method=\"POST\" >";
            
                    for($i=0;$i<$rows;$i++) { ?>
                        
                        <td><input type="submit" name="sel" id="sel" class="w3-block w3-button w3-blue w3-round-large w3-large" value="<?php echo $_SESSION['all_subscriptions_users'][$i][1];?> "></td></p>
