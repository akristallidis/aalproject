        ...
        <?php
            ...
            echo "<div class=\"w3-top w3-theme\">";
                ...
                echo "<div class=\"w3-display-topleft\">";
                    echo "<td><input type=\"submit\" class=\"w3-button w3-blue w3-round-large w3-xxlarge\" onclick=\"window.location.href='http://aalproject.000webhostapp.com/aal/simple_users/menu.php'\" name=\"action\" value=\"⇦\" /></td></p>";
                echo "</div>";
            ...
            echo "<div class=\"w3-display-middle\">";
                ...
                echo "<td><input type=\"button\" class=\"w3-block w3-button w3-blue w3-round-large w3-large\" value=\"Λίστα υπηρεσιών\" onclick=\"window.location.href='http://aalproject.000webhostapp.com/aal/api/users/read_social_services_users_for_sub.php'\" /></td></p>";
            
                echo "<td><input type=\"button\" class=\"w3-block w3-button w3-blue w3-round-large w3-large\" value=\"Χάρτης υπηρεσιών\"  onclick=\"alert ('Δεν λειτουργεί προσωρινά.')\" /></td></p>";
            
                echo "<td><input type=\"button\" class=\"w3-block w3-button w3-blue w3-round-large w3-large\" value=\"Τηλέφωνα υπηρεσιών\" onclick=\"window.location.href='http://aalproject.000webhostapp.com/aal/api/users/read_social_services_users_for_phones.php'\" /></td></p>";
