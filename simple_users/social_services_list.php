...
<html lang="en" >
    ...
    <span id='ct' ></span>
        ...
        <?php
            ...
            $rows = $_SESSION['all_subscriptions_rows_num']; //Dynamic number for Rows
            ...
            echo "<div class=\"w3-display-middle w3-container\">";
                ...
                echo "<form action=\"http://aalproject.000webhostapp.com/aal/simple_users/social_reminder.php \" method=\"POST\" >";
                    ...
                    for($i=0;$i<$rows;$i++) { ?>
                        ...
                        <button type="submit" name="selected_id" id="selected_id" class="w3-block w3-button w3-blue w3-round-large w3-large" value="<?php echo $_SESSION['all_subscriptions_table'][$i][0]; ?>" ><?php echo $_SESSION['all_subscriptions_table'][$i][1]; ?></button></p>
