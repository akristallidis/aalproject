        ...
        <?php
            ...
            <?php
                    for($i=0;$i<$rows;$i++) { ?>
                        ...
                        <td><input type="submit" name="phone" id="phone" class="w3-block w3-button w3-blue w3-round-large w3-large" value="☏  <?php echo $_SESSION['all_subscriptions_users'][$i][1];?>" onclick="window.open('tel: <?php echo $_SESSION['all_subscriptions_users'][$i][8];?>');" ></td></p>
