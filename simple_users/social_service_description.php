        ...
        <?php
            ...
            echo "<div class=\"w3-top w3-theme\">";
                ...
                echo "<div class=\"w3-display-topleft\">";
                    echo "<td><input type=\"submit\" class=\"w3-button w3-blue w3-round-large w3-xxlarge\" onclick=\"window.location.href='http://aalproject.000webhostapp.com/aal/simple_users/social_services_description_list.php'\" name=\"action\" value=\"⇦\" /></td></p>";
                echo "</div>";
