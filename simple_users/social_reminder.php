...
<html lang="en" >
    ...
    <span id='ct' ></span>
        ...
        <?php
            ...
            $a=$_POST['selected_id'];
            $rows = $_SESSION['all_subscriptions_rows_num'];
            
            echo "<div class=\"w3-display-middle w3-container\">";
            
                for($i=0;$i<$rows;$i++) {
                    if ($_SESSION['all_subscriptions_table'][$i][0]==$a) {
                        echo "<div class=\"w3-panel w3-light-blue w3-round-large\">";
                            echo $_SESSION['all_subscriptions_table'][$i][1];
                        echo "</div>";
                        echo "<div class=\"w3-panel w3-light-blue w3-round-large\">";
                            echo $_SESSION['all_subscriptions_table'][$i][2];
                        echo "</div>";
                        echo "<div class=\"w3-panel w3-light-blue w3-round-large\">";
                            echo $_SESSION['all_subscriptions_table'][$i][3];
                        echo "</div>";
                        echo "<div class=\"w3-panel w3-light-blue w3-round-large\">";
                            echo $_SESSION['all_subscriptions_table'][$i][4];
                        echo "</div>";
                    }
                }
