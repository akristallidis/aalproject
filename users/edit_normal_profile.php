    ...
    <span id='ct' ></span>
        ...
        echo "<div class=\"w3-top w3-theme\">";
            ...
            echo "<div class=\"w3-display-middle w3-container\">";
                ...
                echo "<td><input type=\"button\" class=\"w3-block w3-button w3-blue w3-round-large w3-large\" value=\"Ενημέρωση προσωπικών στοιχείων\" onclick=\"window.location.href='http://aalproject.000webhostapp.com/aal/users/edit_normal_profile_data.php'\" /></td></p>";
            
                echo "<td><input type=\"button\" class=\"w3-block w3-button w3-blue w3-round-large w3-large\" value=\"Ενημέρωση κωδικού πρόσβασης\" onclick=\"window.location.href='http://aalproject.000webhostapp.com/aal/users/edit_normal_profile_password.php'\" /></td></p>";
            
                echo "<input type=\"button\" name=\"action\" class=\"w3-block w3-button w3-blue w3-round-large w3-large\" value=\"Διαγραφή προφίλ\" onclick=\"if (confirm('Προσοχή!!!\\nΤο προφίλ χρήστη και όλες οι καταχωρήσεις\\nπρόκειται να διαγραφούν.')) {window.location.href='http://aalproject.000webhostapp.com/aal/api/reminders/delete_all.php'}\"/></p>";
